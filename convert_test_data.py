...
dataset = load_dataset("bigbio/bc5cdr", name="bc5cdr_bigbio_kb", trust_remote_code=True, split="test")
...
def convert_to_spacy_format(dataset, output_file="bc5cdr_test.spacy"):
    doc_bin = DocBin()
    skipped_entities = 0
